...
const COMPANY_CUSTOM_STRATEGIES = {
  ...
  'comp-udon-44': {
    ...
    customRecommendations: [
      ...
      'comp-udon-17': {
    customDiagnostic: 'บริษัทรับสร้างบ้านและงานสถาปัตยกรรมอีสานประยุกต์/โมเดิร์น (E House Construction & Design) โดยมี คุณเอ๊ะ (094-8289263) ดูแลฝ่ายขายและ BOQ มียอดซื้อ SCG ปี 2026 อยู่ที่ <strong>฿569,818 (SCG Code: 10383888)</strong> รับงานทั้งโครงการบ้านพักอาศัยเดี่ยวพรีเมียมและอาคารพาณิชย์คาเฟ่ 3 ชั้น ในเขต อ.เมือง จ.อุดรธานี มีความต้องการวัสดุโครงสร้าง ผนังตกแต่ง และงานระบบฝ้าเพดาน/ฉนวนกันเสียงคุณภาพสูง',
    customRecommendations: [
      ...
      '<strong>ชุดสุขภัณฑ์และก๊อกน้ำ COTTO Commercial & Modern Series:</strong> นำเสนอแพ็กเกจสุขภัณฑ์ประหยัดน้ำและระบบท่อสำหรับคาเฟ่และบ้านพักอาศัย พร้อมบริการรับประกันอุปกรณ์',
      '<strong>อิฐมวลเบา Q-CON & ปูนเสือมอร์ตาร์สูตรเฉพาะงานฉาบ:</strong> นำเสนออิฐมวลเบา Q-CON และปูนฉาบสำเร็จรูปเสือมอร์ตาร์ สำหรับโครงการบ้านเดี่ยวโมเดิร์น เพิ่มความรวดเร็วและผนังเรียบเนียนได้มาตรฐาน',
      '<strong>ไม้สังเคราะห์และแผ่นตกแต่ง SCG D-COR (Facade & Exterior):</strong> เจาะกลุ่มงานตกแต่งฟาซาดหน้าอาคารคาเฟ่และระแนงตกแต่งบ้านสไตล์ Modern Loft'
    ]
  },
  'comp-udon-20': {
