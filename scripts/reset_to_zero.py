...
# Load base 19 companies structure
companies_base = [
  {
    "id": "comp-01",
...
with open("c:/Users/pannipan/Downloads/N/js/data.js", "w", encoding="utf-8") as f:
  f.write(js_content)

with open("c:/Users/pannipan/Downloads/N/data.js", "w", encoding="utf-8") as f:
  f.write(js_content)

# Update index.html and NEX SAKON.html
with open("c:/Users/pannipan/Downloads/N/index.html", "r", encoding="utf-8") as f:
  html_content = f.read()

injection = f"""    <!-- Embedded Full 64 Projects Master Dataset -->
    <script>
{js_content}
    </script>
    <!-- App JS modules -->
...
target_pattern = r'(?s)<!-- Embedded Full 64 Projects Master Dataset -->.*?<script src="js/app\.js"></script>'
if not re.search(target_pattern, html_content):
  target_pattern = r'(?s)<!-- App JS modules -->.*?<script src="js/app\.js"></script>'

new_html = re.sub(target_pattern, injection, html_content)

with open("c:/Users/pannipan/Downloads/N/index.html", "w", encoding="utf-8") as f:
  f.write(new_html)

with open("c:/Users/pannipan/Downloads/N/NEX SAKON.html", "w", encoding="utf-8") as f:
  f.write(new_html)

print("SUCCESSFULLY_RESET_TO_ZERO")
