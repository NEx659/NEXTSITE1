...
def check_strict_udon_location(raw_text):
    ...
    1. ตัด Footer / ที่ตั้งสำนักงาน / เบอร์ติดต่อ / รายชื่อจังหวัดที่ให้บริการ ท้ายโพสต์ทิ้ง
    2. ตัด Hashtags ท้ายโพสต์ออก
    3. เช็กว่าหน้างานจริงอยู่ในจังหวัดอื่น (เช่น 📍 อ.ภูเขียว จ.ชัยภูมิ) หรือไม่ ถ้าใช่ตัดทิ้งทันที
    4. ต้องมีคำว่า "อุดร" หรือ "อุดรธานี" ในเนื้อหาหน้างาน
    5. ต้องมีชื่อ 1 ใน 20 อำเภอ ของ จ.อุดรธานี ในเนื้อหาหน้างาน
    """
    if not raw_text:
        return False, None, []
    ...
    footer_delims = [
        ...
        "ขอนแก่น |", "| อุดรธานี", "| สกลนคร", "#รับสร้างบ้าน", "#สร้างบ้าน"
    ]
