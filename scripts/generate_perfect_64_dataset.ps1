# PowerShell script to generate the 100% accurate, fully consistent 64 projects dataset
# with precise BOQ materials matching all 5 SCG product categories
...
Set-Content -Path "c:\Users\pannipan\Downloads\N\js\data.js" -Value $jsDataContent -Encoding UTF8
Set-Content -Path "c:\Users\pannipan\Downloads\N\data.js" -Value $jsDataContent -Encoding UTF8
...
if ($htmlContent -notmatch $targetPattern) {
...
Write-Host "✅ Successfully updated and synchronized all 64 projects with 100% accurate BOQ materials!"
