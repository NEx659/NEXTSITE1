# PowerShell script to generate full 64 projects in js/data.js
$companies = @(
  @{
    id = "comp-01"
...
Set-Content -Path "c:\Users\pannipan\Downloads\N\js\data.js" -Value $jsContent -Encoding UTF8
Write-Host "✅ Generated 64 projects in js/data.js successfully!"
