...
# Also copy to scripts/facebook_54_pages_posts.json for persistence
Copy-Item -LiteralPath $datasetPath -Destination 'c:\Users\pannipan\Downloads\N\scripts\facebook_54_pages_posts.json' -Force
