...
$url = "file:///c:/Users/pannipan/Downloads/N/scratch/dump_nayoo_chrome.html"
$tempOut = "c:\Users\pannipan\Downloads\N\scratch\nayoo_raw_out.html"
...
if ($html -match '<pre id="out">([\s\S]*?)</pre>') {
    Set-Content -Path "c:\Users\pannipan\Downloads\N\scratch\nayoo_posts.json" -Value $matches[1] -Encoding UTF8
    Write-Output "Saved nayoo_posts.json successfully!"
} else {
