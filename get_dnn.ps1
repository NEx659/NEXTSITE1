...
$item = $dataList | Where-Object { $_.id -eq "comp-udon-55" }
$item | ConvertTo-Json -Depth 10 | Out-File -Encoding UTF8 scratch/dnn_data.json
Get-Content scratch/dnn_data.json
