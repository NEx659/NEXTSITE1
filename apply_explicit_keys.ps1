...
# Give explicit unique siteKeys
$newProjects[0].siteKey = "lecrown_site_modern_gable_419"
$newProjects[1].siteKey = "lecrown_site_plaster_180"
$newProjects[2].siteKey = "lecrown_site_luxury_480"
$newProjects[3].siteKey = "lecrown_site_brick_180"
...
Write-Output "SUCCESS: Added explicit siteKeys to keep all 4 projects separate!"
